...
%% 加载数据
load('D:/蚁群算法（使用）/ACO—CVRP/蚁群具有容量限制的车辆路径问题/City.mat')	      %需求点经纬度，用于画实际路径的XY坐标
load('D:/蚁群算法（使用）/ACO—CVRP/蚁群具有容量限制的车辆路径问题/Distance.mat')	  %距离矩阵
load('D:/蚁群算法（使用）/ACO—CVRP/蚁群具有容量限制的车辆路径问题/Demand.mat')       %需求量
load('D:/蚁群算法（使用）/ACO—CVRP/蚁群具有容量限制的车辆路径问题/Capacity.mat')     %车容量约束
